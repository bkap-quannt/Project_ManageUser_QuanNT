 ...
 * Common.java, Jul 8, 2015, Nguyễn Trường Quân
 */
...
public class Common {
	...
	public static int getTotalPage(int totalRecord, int limit) {
		...
		//ceil() :trả lại giá trị nhỏ nhất kiểu double mà không nhỏ hơn đối số và lại bằng số nguyên
	}

	/**
	 * getCurrentSection
	 * @param curentPage trang hiện tại
	 ...
	 * Tổng số section
	 * @param range phạm vị
	 * @return totalSection: Tổng số section
	 */
	 ...
	 * @param curentPage
	 * @param range
	 * @return List<Integer> chuỗi liên kết đến các trang khác
	 */
	public static List<Integer> getListPage(int totalPage, int currentPage, int range) {
		...
		int curentSection = getCurrentSection(currentPage, range);
		int minPageSection = (curentSection * range) - range + 1;
		int maxPageSection = (curentSection * range);
     ...
     * @param record_per_page int
     * @param page_range int
     * @param url String
     * @param pageid int
     * @param f_name_js String
